  ...
  >
    ...
    <div class="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 gap-1.5">
      <div class="flex justify-start items-center flex-grow relative gap-2">
        ...
        <p class="flex-grow-0 flex-shrink-0 text-xs text-left text-gray-600">{{ Nombre_chambre }}</p>
      </div>
      <div class="flex justify-center items-center flex-grow relative gap-2">
        <svg
          ...
          preserveAspectRatio="xMidYMid meet"
        >
          <g clip-path="url(#clip0_32953_418)">
            <path
          ...
          <defs>
            <clipPath id="clip0_32953_418">
              <rect width="20" height="20" fill="white" transform="translate(0.5)"></rect>
            </clipPath>
          </defs>
        </svg>
        <p class="flex-grow-0 flex-shrink-0 text-xs text-left text-gray-600">{{ Nombre_salle_de_bain }}</p>
      </div>
      <div class="flex justify-end items-center flex-grow relative gap-2">
        ...
        >
          <g clip-path="url(#clip0_32953_426)">
            <path
          ...
          <defs>
            <clipPath id="clip0_32953_426">
              <rect width="20" height="20" fill="white"></rect>
            </clipPath>
          </defs>
        </svg>
        <p class="flex-grow-0 flex-shrink-0 text-xs text-left text-gray-600">{{ Surface_m2 }} m²</p>
      </div>
    </div>
  </div>
</div>
